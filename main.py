...
# Dataset maker
dataset = SoundDataset(audio_path=audio_path, frame_size=frame_size, hop_size=hop_size, sampling_rate=sampling_rate, N_filter_bank=N_filter_bank)
...
for epoch in range(num_epochs):
    ...
    for batch in tqdm(dataloader, desc=f"Epoch {epoch + 1}/{num_epochs}"):
        ...
        # Forward pass
        reconstructed_signal, _ = model(spectral_centroid, loudness, ds_signal)
