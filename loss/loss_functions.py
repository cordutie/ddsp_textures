...
def batch_statistics_loss(original_signals, reconstructed_signals, erb_bank, log_bank):
...
def sub_statistics_loss(original_signal, reconstructed_signal, erb_bank):
    ...
    final_loss = loss[0] + 10 * loss[1]

    return final_loss

def batch_sub_statistics_loss(original_signals, reconstructed_signals, erb_bank):
    batch_size = original_signals.size(0)
    total_loss = 0.0
