...
def batch_statistics_loss(original_signals, reconstructed_signals, N_filter_bank, M_filter_bank, erb_bank, log_bank, downsampler):
...
def batch_statistics_loss_stems(original_signals, reconstructed_stems, N_filter_bank=16, sample_rate=44100):
    low_lim = 20  # Low limit of filter
    high_lim = sample_rate / 2  # Centre freq. of highest filter
